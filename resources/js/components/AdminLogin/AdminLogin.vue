<template>
  <div class="row justify-content-center mt-5">
    <div class="col-md-3">
      <h4 data-aos="fade-left" class="text-success" align="center"><i class="fa fa-user-circle"></i> Admin Log In</h4>
    ...
    <!--   <p class="decode-result">Last result: <b class="text-warning">{{ result }}</b></p> -->
      ...
      <p data-aos="zoom-in" data-aos-delay="2000" align="center">powered by <i class="fa fa-code mt-2"></i> codehive</p>
    </div>
  </div>
</template>
